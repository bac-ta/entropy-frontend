                ...
                <div className="e-side-bar-box__content">
                    <ul className="e-side-bar-box__content__menu">
                        <li className="e-side-bar-box__content__menu__item">
                            <FontAwesomeIcon
                                icon={faChevronRight} className="category-parent-icon"></FontAwesomeIcon>
                            Languages
                            <ul>
                        ...
                        <li className="e-side-bar-box__content__menu__item"><FontAwesomeIcon
                            icon={faChevronRight} className="category-parent-icon"></FontAwesomeIcon>Caches
                            <ul>
                        ...
                        <li className="e-side-bar-box__content__menu__item"><FontAwesomeIcon
                            icon={faChevronRight} className="category-parent-icon"></FontAwesomeIcon>DevOps
                            <ul>
                                <li className="e-side-bar-box__content__menu__item__children"><Link
                        ...
                        <li className="e-side-bar-box__content__menu__item"><FontAwesomeIcon
                            icon={faChevronRight} className="category-parent-icon"></FontAwesomeIcon>BigData
                            <ul>
